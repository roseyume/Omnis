...
(("undefined" != typeof global ? global : self).webpackJsonp = ("undefined" != typeof global ? global : self).webpackJsonp || []).push([ [ 1 ], {
    369: function(e, r, i) {
        "use strict";
        var n = i(380), t = i(378), l = i(394), o = i(371), a = i(381), s = i(367), u = i(407), c = i(382), m = Math.max, d = Math.min, b = Math.floor, f = /\$([$&'`]|\d\d?|<[^>]*>)/g, h = /\$([$&'`]|\d\d?)/g;
        n("replace", 2, (function(e, r, i, n) {
            var g = n.REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE, v = n.REPLACE_KEEPS_$0, p = g ? "$" : "$0";
            return [ function(i, n) {
                var t = s(this), l = null == i ? void 0 : i[e];
                return void 0 !== l ? l.call(i, t, n) : r.call(String(t), i, n);
            }, function(e, n) {
                if (!g && v || "string" == typeof n && -1 === n.indexOf(p)) {
                    var l = i(r, e, this, n);
                    if (l.done) return l.value;
                }
                var s = t(e), b = String(this), f = "function" == typeof n;
                f || (n = String(n));
                var h = s.global;
                if (h) {
                    var _ = s.unicode;
                ...
                for (var F = []; ;) {
                    ...
                    if (null === x) break;
                    if (F.push(x), !h) break;
                    "" === String(x[0]) && (s.lastIndex = u(b, o(s.lastIndex), _));
                }
                for (var k, w = "", M = 0, N = 0; N < F.length; N++) {
                    x = F[N];
                    for (var B = String(x[0]), $ = m(d(a(x.index), b.length), 0), E = [], T = 1; T < x.length; T++) E.push(void 0 === (k = x[T]) ? k : String(k));
                    var S = x.groups;
                    if (f) {
                        var P = [ B ].concat(E, $, b);
                        void 0 !== S && P.push(S);
                    ...
                    $ >= M && (w += b.slice(M, $) + L, M = $ + B.length);
                }
                return w + b.slice(M);
            } ];
            function y(e, i, n, t, o, a) {
                var s = n + e.length, u = t.length, c = h;
                return void 0 !== o && (o = l(o), c = f), r.call(a, c, (function(r, l) {
                    var a;
                    switch (l.charAt(0)) {
                      case "$":
                        return "$";
                      ...
                      default:
                        ...
                        if (c > u) {
                            var m = b(c / 10);
                            return 0 === m ? r : m <= u ? void 0 === t[m - 1] ? l.charAt(1) : t[m - 1] + l.charAt(1) : r;
                        }
                        a = t[c - 1];
                    }
                    return void 0 === a ? "" : a;
        ...
        void 0 === (t = "function" == typeof (n = function() {
            ...
            return (e = function(i) {
                ...
                numberToFormat: function(r, i, n) {
                    var t, l, o, s, u, c, m, d = a[e.options.currentLocale], b = !1, f = !1, h = 0, g = "", v = 1e12, p = 1e9, y = 1e6, _ = 1e3, F = "", x = !1;
                    ...
                    l >= v && !t || "t" === t ? (g += d.abbreviations.trillion, r /= v) : l < v && l >= p && !t || "b" === t ? (g += d.abbreviations.billion, 
                    r /= p) : l < p && l >= y && !t || "m" === t ? (g += d.abbreviations.million, r /= y) : (l < y && l >= _ && !t || "k" === t) && (g += d.abbreviations.thousand, 
    ...
    549: function(e, r, i) {
        var n, t, l;
        t = [ i(544) ], void 0 === (l = "function" == typeof (n = function(e) {
            var r;
